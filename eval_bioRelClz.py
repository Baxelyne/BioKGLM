...
from engines.modeling import BertForSequenceClassification
...
def main():
    ...
    for x, mark in file_mark:
        ...
        model, _ = BertForSequenceClassification.from_pretrained(args.bioLM_model, state_dict=model_state_dict,
