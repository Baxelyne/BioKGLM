...
def main():
    ...
    filenames = [x for x in filenames if "post_trained_bioLM_model.bin_" in x]
    ...
    for x, mark in file_mark:
        ...
        model, _ = BertForEntityTyping.from_pretrained(args.bioLM_model, state_dict=model_state_dict,
        ...
        eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_input_ent, all_ent_mask,
                                  all_labels)
