...
def parse_arguments():
    parser = argparse.ArgumentParser(description='measure a prediction file using the gold labels.')
...
def measure(key, prediction, verbose=False):
...
if __name__ == "__main__":
    ...
    measure(key, prediction, verbose=True)
